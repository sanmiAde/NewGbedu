...
class SongWebViewDetailScreenActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val SHOULD_LOAD_SONG_PAGE_INSTEAD_OF_ARTIST =
            "com.sanmiaderibigbe.newgbedu.shouldLoadSongPageInsteadOfArtist"

        fun initSongWebViewDetailScreenActivity(
            context: Context,
            songName: String,
            songArtist: String = "",
            shouldShowSongWebView: Boolean
        ): Intent {
